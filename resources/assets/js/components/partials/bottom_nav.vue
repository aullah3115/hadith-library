<template>
    <div>
      <v-bottom-nav height="60" v-if="$mq == 'sm' || $mq =='md'" fixed :value="true" color="primary" app>
            ...
            <v-btn small icon :to="{ name: 'home', params: {} }" active-class>
              <v-icon small>home</v-icon>
            </v-btn>

            <v-spacer></v-spacer>

            <v-btn small icon @click.native="show('searchbar')">
